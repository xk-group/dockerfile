...
docker run -it -p 8000:8000 -d --name http-actor-container -v $PWD/config-http:/usr/lib/course-selection/config course-selection moe.taiho.course_selection.cluster.WebServer
